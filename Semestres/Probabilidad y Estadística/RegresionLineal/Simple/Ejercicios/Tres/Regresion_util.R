...
regresion_lineal_simple = function(datos, x_nueva=NULL) {
  ...
  plot(x, residuosEstandarizados, pch=16, col="blue", main=titulo, xlab=names(datos)[1],
       ylab="Residuos")
  abline(h = 0, col = "red")
  # Histograma de residuos
  hist(residuosEstandarizados, main="Histograma de Residuos", xlab="Residuos", ylab="Frecuencia", col="blue")
  # Gráfica de probabilidad normal (Q-Q Plot)
  qqnorm(residuosEstandarizados, pch = 16, col = "blue", 
  ...
  plot(residuosEstandarizados, col = "blue", 
