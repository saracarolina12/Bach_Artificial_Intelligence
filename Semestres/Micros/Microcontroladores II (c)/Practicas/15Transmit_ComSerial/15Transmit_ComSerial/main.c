/*
 * 15Transmit_ComSerial.c
 *
 * Created: 29/03/2022 04:15:34 p. m.
 * Author : scago
 */ 
...
uint8_t USART_Receive(void) //Se utiliza cuando no se configura la interrupci�n de recepci�n. De preferencia siempre trabajar con interrupci�n.
{
	while (!(UCSRA&(1<<RXC))) {}
	return UDR;
}
